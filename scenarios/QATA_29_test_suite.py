...
@pytest.allure.story('Create project:Journal Project ')
@pytest.mark.test_29
def test_qata_01(log, frontend):
    ...
    frontend.choose_checkbox('Journal Project')
    ...
    frontend.fill_table(
        {
            'Title': 'Test_Journal Project',
            'Project Champion Message': 'Test_Journal Project',
        }
    )
    ...
    #frontend.choose_on_dropdown_in_table('Publication Owner', 'Admin, Jodi')
    ...
    frontend.choose_checkbox('Allow selection of any clinical finding', test=True)
